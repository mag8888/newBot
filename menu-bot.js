...
📖 <b>О проекте</b> - узнай больше об игре
👥 <b>Получить клиентов</b> - найди партнёров
💰 <b>Заработать</b> - монетизируй навыки
🎮 <b>Играть</b> - запусти игру

💡 <b>Советы:</b>
• Все функции доступны через меню внизу
• Нажми на кнопку дважды для активации
• Играй регулярно для лучших результатов
  ...
  try {
    ...
    if (update.message) {
      ...
      if (text === '/start') {
        ...
        await sendMessage(chatId, getHelpMessage(), getMainMenu());
